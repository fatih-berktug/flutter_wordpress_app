...
class MusabakalarYil extends StatefulWidget {
  @override
  _MusabakalarYilState createState() => _MusabakalarYilState();
}

class _MusabakalarYilState extends State<MusabakalarYil> {
  String data;
  ...
  void getData() async {
    http.Response response = await http.get(
        "http://217.116.197.114:8080/fusio/public/index.php/competition-years");
