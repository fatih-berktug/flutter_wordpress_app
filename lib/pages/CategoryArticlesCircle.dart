...
import 'package:flutter_wordpress_app/widgets/articleBoxCircle.dart';
import 'package:http/http.dart' as http;
import 'package:loading/indicator/ball_beat_indicator.dart';
import 'package:loading/loading.dart';

class CategoryArticlesCircle extends StatefulWidget {
  final int id;
  final String name;

  CategoryArticlesCircle(this.id, this.name, {Key key}) : super(key: key);

  @override
  _CategoryArticlesCircleState createState() => _CategoryArticlesCircleState();
}

class _CategoryArticlesCircleState extends State<CategoryArticlesCircle> {
  ...
  Future<List<dynamic>> fetchCategoryArticles(int page) async {
    try {
      ...
      throw 'İnternet bağlantısı bulunamadı!';
    }
    return categoryArticles;
  }
